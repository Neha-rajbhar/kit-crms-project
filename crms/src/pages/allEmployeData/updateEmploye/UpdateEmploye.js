...
import style from "./UpdateEmploye.module.css";
function UpdateEmploye() {
  ...
  useEffect(() => {
    axios
      .get("https://accessible-mewing-iguana.glitch.me/getEmployeById/" + id)
      .then((result) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        const response = await axios.post(
          "https://accessible-mewing-iguana.glitch.me/updateEmployeById/" + id,
          {
            userId,
            firstName,
            lastName,
